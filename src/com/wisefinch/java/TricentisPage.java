 ...
 *
 */
public class TricentisPage extends DriverScript{
	 ...
	 * @param report
	 */
	protected TricentisPage(WebDriver browser) {
...
ArrayList<String> enddate_arr= new ArrayList<String>();
	 ...
	 * 
	***/
	public synchronized  TricentisPage validateTestA(int threadID , List<String> tempList , String pathLoc ) throws IOException, AWTException {
		String testcasemethod = new Object(){}.getClass().getEnclosingMethod().getName();
	try{
		String username = null, pass_login = null;
		String make = null, enginePerformance = null, date = null;
		make = reusableComponents.getPropValues("Make");
		enginePerformance = reusableComponents.getPropValues("EnginePerformance");
		date = reusableComponents.getPropValues("Date");
		
		if(ReusableComponents.isElementPresent(LandingHeader)){
			
			ReusableComponents.wait(1200);
			
			if(ReusableComponents.isElementPresent(validation_1)){
				
				ReusableComponents.wait(1200);
			
				if(ReusableComponents.isElementPresent(makeSelect)){
					
					Select drpCountry = new Select(browser.findElement(By.xpath("//select[@id='make']")));
					drpCountry.selectByVisibleText(make);
					
					ReusableComponents.wait(1200);
					
					if(ReusableComponents.isElementPresent(EnginePerformance)){
						
						EnginePerformance.clear();
						EnginePerformance.sendKeys(enginePerformance);
												
						ReusableComponents.wait(1200);
					
									
					}else{
						ReusableComponents.reportFail( threadID , tempList , testcasemethod , "EnginePerformance is NOT present", browser ,pathLoc+"\\"+testcasemethod , true );
					}
					
					if(ReusableComponents.isElementPresent(dateofmanufacture)){
					...
					ReusableComponents.reportFail( threadID , tempList , testcasemethod , "Make is NOT present", browser ,pathLoc+"\\"+testcasemethod , true );
				}	
			}else{
				ReusableComponents.reportFail( threadID , tempList , testcasemethod , "Enter vehicle data is NOT present", browser ,pathLoc+"\\"+testcasemethod , true );
			}
						
		}else{
			ReusableComponents.reportFail( threadID , tempList , testcasemethod , "Landing Header is NOT present", browser ,pathLoc+"\\"+testcasemethod , true );
		}
		
		//browser.switchTo().defaultContent();
		
		/*
		 * username = reusableComponents.getPropValues("usernameopenhrm"); pass_login =
		 * reusableComponents.getPropValues("passwordopenhrm");
		 */
	 ...
	 * 
	***/
	public synchronized  TricentisPage validateTestOpp(int threadID , List<String> tempList , String pathLoc ) throws IOException, AWTException {
		String testcasemethod = new Object(){}.getClass().getEnclosingMethod().getName();
	try{
	 ...
	 * 
	***/
	public synchronized  TricentisPage validateTestB(int threadID , List<String> tempList , String pathLoc ) throws IOException, AWTException {
		String testcasemethod = new Object(){}.getClass().getEnclosingMethod().getName();
	try{
		/*
		 * boolean test=false;
...
//		  
	 ...
	 * 
	***/
	public synchronized  TricentisPage validateTestC(int threadID , List<String> tempList , String pathLoc ) throws IOException, AWTException {
		String testcasemethod = new Object(){}.getClass().getEnclosingMethod().getName();
	try{
...
//					   js.executeScript("window.scrollBy(document.body.scrollHeight,0)");
	 ...
	 * 
	***/
	public synchronized  TricentisPage validateTestD(int threadID , List<String> tempList , String pathLoc ) throws IOException, AWTException {
		String testcasemethod = new Object(){}.getClass().getEnclosingMethod().getName();
	try{
