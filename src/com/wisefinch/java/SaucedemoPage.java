 ...
 *
 */
public class SaucedemoPage extends DriverScript{
	 ...
	 * @param report
	 */
	protected SaucedemoPage(WebDriver browser) {
...
//saucedemo login webelements

@FindBy(xpath = "//input[@id='user-name']")
WebElement saucelabs_username;

@FindBy(xpath = "//input[@id='password']")
WebElement saucelabs_password;

@FindBy(xpath = "//input[@id='login-button']")
WebElement saucelabs_login;
...
ArrayList<String> enddate_arr= new ArrayList<String>();
	 ...
	 * 	 Functionality         : validate login to saucedemo page
	 * 	 Created By			   : Lakshman
	 * @throws IOException 
	 * @throws AWTException 
	 * 
	***/
	public synchronized  SaucedemoPage validateTestA(int threadID , List<String> tempList , String pathLoc ) throws IOException, AWTException {
	...
	try{
		...
		username = reusableComponents.getPropValues("usernamesauce");
		pass_login = reusableComponents.getPropValues("passwordsauce");
		
		ReusableComponents.wait(2300);
		
		if(ReusableComponents.isElementPresent(saucelabs_username)){
		...
		//	ReusableComponents.reportPass( threadID , tempList , testcasemethod , "login_user_field is present", browser ,pathLoc+"\\"+testcasemethod , false );
			...
			saucelabs_username.sendKeys(username);
			
			if(ReusableComponents.isElementPresent(saucelabs_password)){
				
				saucelabs_password.sendKeys(pass_login);				
				ReusableComponents.wait(1200);
				
				
				if(ReusableComponents.isElementPresent(saucelabs_login)){
					
					ReusableComponents.wait(1200);
					saucelabs_login.click();
	 ...
	 * 
	***/
	public synchronized  SaucedemoPage validateTestOpp(int threadID , List<String> tempList , String pathLoc ) throws IOException, AWTException {
		String testcasemethod = new Object(){}.getClass().getEnclosingMethod().getName();
	try{
	 ...
	 * 
	***/
	public synchronized  SaucedemoPage validateTestB(int threadID , List<String> tempList , String pathLoc ) throws IOException, AWTException {
		String testcasemethod = new Object(){}.getClass().getEnclosingMethod().getName();
	try{
		/*
		 * boolean test=false;
...
//		  
	 ...
	 * 
	***/
	public synchronized  SaucedemoPage validateTestC(int threadID , List<String> tempList , String pathLoc ) throws IOException, AWTException {
		String testcasemethod = new Object(){}.getClass().getEnclosingMethod().getName();
	try{
...
//					   js.executeScript("window.scrollBy(document.body.scrollHeight,0)");
	 ...
	 * 
	***/
	public synchronized  SaucedemoPage validateTestD(int threadID , List<String> tempList , String pathLoc ) throws IOException, AWTException {
		String testcasemethod = new Object(){}.getClass().getEnclosingMethod().getName();
	try{
