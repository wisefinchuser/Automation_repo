...
public class TricentistestClass extends DriverScript{
	...
	@Test
	@Parameters({"platform" , "browserName" , "remoteurl"}) 
	public synchronized void validate_Tricentis_minimum_rev1(@Optional("opt platform") String platform ,@Optional("opt browser name") String browserName ,@Optional("opt remoteurl") String remoteurl) throws IOException, AWTException{
		...
		String url = reusableComponents.getPropValues("tricentisurl");
...
//		System.out.println("Test Case  with Thread Id:- "+ Thread.currentThread().getId());
		...
		page.navigateToTricentistestPage(threadID,tempResultList ,pathLoc)
		...
		ReusableComponents.reportInfo(threadID,tempResultList,testMethod , "Test case : Validating tricentis case", browser ,pathLoc+"\\"+TESTCASENAME , false );
