...
public class TricentisClass extends DriverScript{
	...
	@Test
	@Parameters({"platform" , "browserName" , "remoteurl"}) 
	public synchronized void validate_Tricentis(@Optional("opt platform") String platform ,@Optional("opt browser name") String browserName ,@Optional("opt remoteurl") String remoteurl) throws IOException, AWTException{
...
//		System.out.println("Test Case  with Thread Id:- "+ Thread.currentThread().getId());
		...
		ReusableComponents.reportInfo(threadID,tempResultList,testMethod , "Test case : Validating the Tricentis Page test case", browser ,pathLoc+"\\"+TESTCASENAME , false );
