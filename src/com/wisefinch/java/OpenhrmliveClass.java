...
public class OpenhrmliveClass extends DriverScript{
	...
	@Test
	@Parameters({"platform" , "browserName" , "remoteurl"}) 
	public synchronized void validate_Openhrm_live_Rev1(@Optional("opt platform") String platform ,@Optional("opt browser name") String browserName ,@Optional("opt remoteurl") String remoteurl) throws IOException, AWTException{
		...
		String url = reusableComponents.getPropValues("openhrmurl");
...
//		System.out.println("Test Case  with Thread Id:- "+ Thread.currentThread().getId());
		...
		page.navigateToOpenhrmlivePage(threadID,tempResultList ,pathLoc)
		...
		ReusableComponents.reportInfo(threadID,tempResultList,testMethod , "Test case : Validating the open hrm live Page test case", browser ,pathLoc+"\\"+TESTCASENAME , false );
