 ...
 *
 */
public class OpenhrmlivePage extends DriverScript{
	 ...
	 * @param report
	 */
	protected OpenhrmlivePage(WebDriver browser) {
...
ArrayList<String> enddate_arr= new ArrayList<String>();
	 ...
	 * 	 Functionality         : validate login to openhrmlive page
	 * 	 Created By			   : Subramanya MS
	 * @throws IOException 
	 * @throws AWTException 
	 * 
	***/
	public synchronized  OpenhrmlivePage validateTestA(int threadID , List<String> tempList , String pathLoc ) throws IOException, AWTException {
	...
	try{
		...
		username = reusableComponents.getPropValues("usernameopenhrm");
		pass_login = reusableComponents.getPropValues("passwordopenhrm");
		
		ReusableComponents.wait(2300);
		
		if(ReusableComponents.isElementPresent(login_name)){
		...
		//	ReusableComponents.reportPass( threadID , tempList , testcasemethod , "login_user_field is present", browser ,pathLoc+"\\"+testcasemethod , false );
			...
			if(ReusableComponents.isElementPresent(Pass_entry)){
				
				Pass_entry.sendKeys(pass_login);				
				ReusableComponents.wait(1200);
				
				
				if(ReusableComponents.isElementPresent(login_click)){
	 ...
	 * 
	***/
	public synchronized  OpenhrmlivePage validateTestOpp(int threadID , List<String> tempList , String pathLoc ) throws IOException, AWTException {
		String testcasemethod = new Object(){}.getClass().getEnclosingMethod().getName();
	try{
	 ...
	 * 
	***/
	public synchronized  OpenhrmlivePage validateTestB(int threadID , List<String> tempList , String pathLoc ) throws IOException, AWTException {
		String testcasemethod = new Object(){}.getClass().getEnclosingMethod().getName();
	try{
		/*
		 * boolean test=false;
...
//		  
	 ...
	 * 
	***/
	public synchronized  OpenhrmlivePage validateTestC(int threadID , List<String> tempList , String pathLoc ) throws IOException, AWTException {
		String testcasemethod = new Object(){}.getClass().getEnclosingMethod().getName();
	try{
...
//					   js.executeScript("window.scrollBy(document.body.scrollHeight,0)");
	 ...
	 * 
	***/
	public synchronized  OpenhrmlivePage validateTestD(int threadID , List<String> tempList , String pathLoc ) throws IOException, AWTException {
		String testcasemethod = new Object(){}.getClass().getEnclosingMethod().getName();
	try{
