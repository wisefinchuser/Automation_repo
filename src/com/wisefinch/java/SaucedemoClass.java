...
public class SaucedemoClass extends DriverScript{
	...
	@Test
	@Parameters({"platform" , "browserName" , "remoteurl"}) 
	public synchronized void validate_saucedemo_Rev1(@Optional("opt platform") String platform ,@Optional("opt browser name") String browserName ,@Optional("opt remoteurl") String remoteurl) throws IOException, AWTException{
		...
		String url = reusableComponents.getPropValues("saucedemourl");
...
//		System.out.println("Test Case  with Thread Id:- "+ Thread.currentThread().getId());
		...
		page.navigateToSaucedemoPage(threadID,tempResultList ,pathLoc)
		...
		ReusableComponents.reportInfo(threadID,tempResultList,testMethod , "Test case : Validating the saucedemo Page test case", browser ,pathLoc+"\\"+TESTCASENAME , false );
